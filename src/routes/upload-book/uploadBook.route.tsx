...
const UploadBook = ({ theme, setRoute }: RouteProps): JSX.Element => {
    const [formFields, setFormFields] = useState(variables.defaultStates.uploadBook);
    ...
    useEffect(() => {
        ...
        setRoute(variables.routes.uploadBook);
    }, [dispatch, setRoute]);
                ...
                <SquareWrapper>
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <CartItemButton buttonName={dropdownScroll} onClick={() => setOpenCatalog(!openCatalog)}>
                            <ButtonTitle buttonName={dropdownScroll}>{openCatalog? variables.buttons.scrollUp: variables.buttons.scrollDown}</ButtonTitle>
                        </CartItemButton>
                    </div>
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <CartItemButton buttonName={dropdownScroll} onClick={() => setOpenData(!openData)}>
                            <ButtonTitle buttonName={dropdownScroll}>{openData? variables.buttons.scrollUp: variables.buttons.scrollDown}</ButtonTitle>
                        </CartItemButton>
                    </div>
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <CartItemButton buttonName={dropdownScroll} onClick={() => setOpenPurchase(!openPurchase)}>
                            <ButtonTitle buttonName={dropdownScroll}>{openPurchase? variables.buttons.scrollUp: variables.buttons.scrollDown}</ButtonTitle>
                        </CartItemButton>
                    </div>
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <CartItemButton buttonName={dropdownScroll} onClick={() => setOpenShipping(!openShipping)}>
                            <ButtonTitle buttonName={dropdownScroll}>{openShipping? variables.buttons.scrollUp: variables.buttons.scrollDown}</ButtonTitle>
                        </CartItemButton>
                    </div>
