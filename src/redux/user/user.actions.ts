...
export const checkUserSession = withMatcher((): CheckUserSession => createAction(UserTypes.CHECK_USER_SESSION));

export type SetCurrentUser = ActionWithPayload<UserTypes.SET_CURRENT_USER, TokenType>;
export const setCurrentUser = withMatcher((tokens: TokenType): SetCurrentUser => (createAction(UserTypes.SET_CURRENT_USER, tokens)));
...
export const googleSignInStart = withMatcher((): GoogleSignInStart => createAction(UserTypes.GOOGLE_SIGN_IN_START));

export type FacebookSignInStart = Action<UserTypes.FACEBOOK_SIGN_IN_START>;
export const facebookSignInStart = withMatcher((): FacebookSignInStart => createAction(UserTypes.FACEBOOK_SIGN_IN_START));

export type TwitterSignInStart = Action<UserTypes.TWITTER_SIGN_IN_START>;
export const twitterSignInStart = withMatcher((): TwitterSignInStart => createAction(UserTypes.TWITTER_SIGN_IN_START));

export type SignInSuccess = ActionWithPayload<UserTypes.SIGN_IN_SUCCESS, TokenType> 
export const signInSuccess = withMatcher((tokens: TokenType & {id?: string | undefined}): SignInSuccess => createAction(UserTypes.SIGN_IN_SUCCESS, tokens));

export type SignInFailure = ActionWithPayload<UserTypes.SIGN_IN_FAILED, Error>
export const signInFailure = withMatcher((error: Error): SignInFailure => createAction(UserTypes.SIGN_IN_FAILED, error));
...
export const signUpSuccess = withMatcher((tokens: TokenType): SignUpSuccess => createAction(UserTypes.SIGN_UP_SUCCESS, tokens));

export type SignUpFailure = ActionWithPayload<UserTypes.SIGN_UP_FAILED, Error>
export const signUpFailure = withMatcher((error: Error): SignUpFailure => createAction(UserTypes.SIGN_UP_FAILED, error));
...
export type UpdateAccessTokenStart = Action<UserTypes.UPDATE_ACCESS_TOKEN_START>;
export const updateAccessTokenStart = withMatcher((): UpdateAccessTokenStart => createAction(UserTypes.UPDATE_ACCESS_TOKEN_START))

export type UpdateAccessTokenFailure = ActionWithPayload<UserTypes.UPDATE_ACCESS_TOKEN_FAILED, Error>
export const updateAccessTokenFailure = withMatcher((error: Error): UpdateAccessTokenFailure => createAction(UserTypes.UPDATE_ACCESS_TOKEN_FAILED, error));

export type UpdateAccessTokenSuccess = ActionWithPayload<UserTypes.UPDATE_ACCESS_TOKEN_SUCCESS, string>;
export const updateAccessTokenSuccess = withMatcher((accessToken: string): UpdateAccessTokenSuccess => createAction(UserTypes.UPDATE_ACCESS_TOKEN_SUCCESS, accessToken));