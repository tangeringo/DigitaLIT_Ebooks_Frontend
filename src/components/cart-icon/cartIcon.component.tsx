...
import { selectCanIconPulse, selectCartCount, selectIsCartOpen } from '../../redux/cart/cart.selectors';
import { setCartIconPulse, setIsCartOpen } from '../../redux/cart/cart.actions';
